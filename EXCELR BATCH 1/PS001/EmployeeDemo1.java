...
class EmployeeDemo {
	...
	public EmployeeDemo(int id, String firstName, String lastName, String address) {
		super();
		this.id = id;
...
class FullTimeEmployee extends EmployeeDemo {
...
class PartTimeEmployee extends EmployeeDemo {
